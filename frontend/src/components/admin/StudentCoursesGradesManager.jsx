  ...
  return (
    <div className="animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 gap-10">
        ...
        <div className="bg-white/80 dark:bg-[#111]/80 border border-gray-200 dark:border-white/10 rounded-[2.5rem] p-8 shadow-sm relative overflow-hidden group transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-300">
            {/* Background Glow */}
            <div className="absolute -right-20 -top-20 w-80 h-80 bg-cyan-500/5 dark:bg-cyan-500/10 rounded-full hidden pointer-events-none"></div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-gray-50/50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-2xl px-12 py-3.5 text-sm font-black focus:ring-4 focus:ring-cyan-500/10 outline-none transition-[color,background-color,border-color,transform,opacity] shadow-inner"
                                />
                            </div>
                        </div>
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="w-full bg-gray-50/50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-2xl px-12 py-3.5 text-sm font-black focus:ring-4 focus:ring-cyan-500/10 outline-none transition-[color,background-color,border-color,transform,opacity] shadow-inner appearance-none uppercase tracking-widest"
                                >
        ...
        {selectedStudent && (
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 animate-in slide-in-from-bottom-6 duration-700">
            {/* Course Enrollment */}
            <div className="bg-white/80 dark:bg-[#111]/80 border border-gray-200 dark:border-white/10 rounded-[2.5rem] overflow-hidden shadow-sm relative group">
                <div className="absolute -left-20 -bottom-20 w-80 h-80 bg-cyan-500/5 rounded-full hidden pointer-events-none"></div>
                ...
                <div className="p-8 border-b border-gray-100 dark:border-white/10 bg-gray-50/50 dark:bg-white/[0.01] flex justify-between items-center relative z-10">
                    ...
                    <button 
                        ...
                        className="px-6 py-3 bg-cyan-600 hover:bg-cyan-700 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest transition-[color,background-color,border-color,transform,opacity] hover:shadow-xl shadow-cyan-500/20 flex items-center gap-2 hover:scale-[1.02] active:scale-95"
                    >
                                ...
                                studentCourses.map((sc) => (
                                    <tr key={sc.id} className="group/item hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                                        <td className="py-6 px-8">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-xl bg-white dark:bg-black border border-gray-200 dark:border-white/10 flex items-center justify-center text-cyan-600 dark:text-cyan-400 shadow-inner group-hover/item:bg-cyan-600 group-hover/item:text-white transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-300">
                                        ...
                                        <td className="py-6 px-8 text-inline-end">
                                            <button 
                                                ...
                                                className="w-11 h-11 flex items-center justify-center rounded-xl bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-500 hover:bg-rose-600 dark:hover:bg-rose-500 hover:text-white transition-[color,background-color,border-color,transform,opacity] shadow-sm"
                                                title="Remove Course"
                                            >
            ...
            {/* Grade Records */}
            <div className="bg-white/80 dark:bg-[#111]/80 border border-gray-200 dark:border-white/10 rounded-[2.5rem] overflow-hidden shadow-sm relative group">
                <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-orange-500/5 rounded-full hidden pointer-events-none"></div>
                                ...
                                studentGrades.map((grade, idx) => (
                                    <tr key={idx} className="group/grade hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                                        ...
                                        <td className="py-6 px-4 text-center">
                                            <div className={`w-11 h-11 rounded-xl mx-auto flex items-center justify-center text-sm font-black border transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-300 ${
                                        ...
                                        <td className="py-6 px-8 text-inline-end">
                                            <button 
                                                ...
                                                className="w-11 h-11 flex items-center justify-center rounded-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-400 dark:text-gray-500 hover:bg-orange-500 hover:text-white hover:border-orange-500 transition-[color,background-color,border-color,transform,opacity] shadow-sm group-hover/grade:scale-[1.05]"
                                                title="Edit Grade"
                                            >
      ...
      {showAddCourseModal && selectedStudent && (
        <div className="fixed inset-0 bg-gray-900/60 dark:bg-black/80 flex items-center justify-center z-50 p-4" onClick={() => setShowAddCourseModal(false)}>
          <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-[2.5rem] p-10 w-full max-w-lg shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-300" onClick={(e) => e.stopPropagation()}>
            {/* Modal Glow */}
            <div className="absolute top-0 inset-inline-end-0 w-64 h-64 bg-cyan-500/10 hidden rounded-full pointer-events-none"></div>
            ...
            <div className="relative z-10">
                ...
                <div className="space-y-8">
                    <div className="space-y-3">
                        ...
                        <div className="relative">
                            <select value={selectedCourseToAdd} onChange={(e) => setSelectedCourseToAdd(e.target.value)} className="w-full bg-gray-50/50 dark:bg-black/50 text-gray-900 dark:text-white border border-gray-200 dark:border-white/10 rounded-2xl px-6 py-4.5 font-black focus:ring-4 focus:ring-cyan-500/10 outline-none transition-[color,background-color,border-color,transform,opacity] shadow-inner appearance-none uppercase tracking-widest text-[13px]">
                    ...
                    <div className="flex gap-4 pt-4 border-t border-gray-100 dark:border-white/10">
                        <button onClick={handleAddCourseToStudent} className="flex-1 bg-cyan-600 hover:bg-cyan-700 text-white font-black py-5 rounded-2xl shadow-xl shadow-cyan-500/20 transition-[color,background-color,border-color,transform,opacity] hover:scale-[1.02] active:scale-95 uppercase tracking-widest text-[11px]">{t('admin.records.add_btn')}</button>
                        <button onClick={() => { setShowAddCourseModal(false); setSelectedCourseToAdd(''); }} className="px-10 bg-gray-100 dark:bg-white/5 text-gray-700 dark:text-gray-300 font-black py-5 rounded-2xl transition-[color,background-color,border-color,transform,opacity] hover:bg-gray-200 dark:hover:bg-white/10 uppercase tracking-widest text-[11px]">{t('admin.records.cancel_btn')}</button>
                    </div>
                </div>
            </div>
          </div>
      ...
      {showGradeModal && editingGrade && selectedStudent && (
        <div className="fixed inset-0 bg-gray-900/60 dark:bg-black/80 flex items-center justify-center z-50 p-4" onClick={() => setShowGradeModal(false)}>
          <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-[2.5rem] p-10 w-full max-w-xl shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-300" onClick={(e) => e.stopPropagation()}>
            {/* Modal Glow */}
            <div className="absolute top-0 inset-inline-end-0 w-64 h-64 bg-orange-500/10 hidden rounded-full pointer-events-none"></div>
                ...
                <form onSubmit={handleUpdateStudentGrade} className="space-y-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                <select value={editGradeForm.examType} onChange={(e) => setEditGradeForm({ ...editGradeForm, examType: e.target.value })} className="w-full bg-gray-50/50 dark:bg-black/50 text-gray-900 dark:text-white border border-gray-200 dark:border-white/10 rounded-2xl px-6 py-4.5 font-black focus:ring-4 focus:ring-orange-500/10 outline-none transition-[color,background-color,border-color,transform,opacity] shadow-inner appearance-none uppercase tracking-widest text-[13px]">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {['completed', 'pending', 'not_held'].map(status => (
                                <button
                                    ...
                                    className={`py-5 rounded-2xl text-[10px] font-black uppercase tracking-widest border transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-300 ${
                    ...
                    <div className="flex gap-4 pt-6 border-t border-gray-100 dark:border-white/10">
                        <button type="submit" className="flex-1 bg-orange-600 hover:bg-orange-700 text-white font-black py-5 rounded-2xl shadow-xl shadow-orange-500/20 transition-[color,background-color,border-color,transform,opacity] hover:scale-[1.02] active:scale-95 uppercase tracking-widest text-[11px]">{t('admin.records.save_btn')}</button>
                        <button type="button" onClick={() => setShowGradeModal(false)} className="px-10 bg-gray-100 dark:bg-white/5 text-gray-700 dark:text-gray-300 font-black py-5 rounded-2xl transition-[color,background-color,border-color,transform,opacity] hover:bg-gray-200 dark:hover:bg-white/10 uppercase tracking-widest text-[11px]">{t('admin.records.cancel_btn')}</button>
                    </div>
                </form>
            </div>
          </div>
