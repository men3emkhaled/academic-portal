    ...
    <div className="space-y-8 lg:space-y-10 animate-in fade-in duration-700 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-start">
        <div className="lg:col-span-2 flex items-center gap-6 bg-white/50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/5 p-8 rounded-[2.5rem] shadow-sm">
          <div className="w-16 h-16 bg-primary/10 dark:bg-primary/20 rounded-2xl flex items-center justify-center border border-primary/20 shadow-inner group transition-transform duration-500 hover:scale-110">
            <CheckSquare className="w-8 h-8 text-primary dark:text-primary" />
          </div>
          <div>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-stretch gap-6">
        <div className="flex flex-col md:flex-row gap-4 flex-1">
            <div className="relative flex-1 group">
                <Search className="absolute inset-inline-start-5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-primary transition-colors" />
                <input 
                    type="text" 
                    placeholder={t('admin.tasks.search_placeholder')}
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                    className="w-full bg-white dark:bg-white/[0.02] border border-gray-100 dark:border-white/10 rounded-2xl ps-14 pe-6 py-4.5 font-black focus:ring-4 focus:ring-primary/10 outline-none transition-all shadow-inner uppercase tracking-widest text-[11px]"
                />
            </div>
            <div className="relative md:w-72">
                ...
                <select 
                    ...
                    className="w-full bg-white dark:bg-white/[0.02] border border-gray-100 dark:border-white/10 rounded-2xl ps-14 pe-10 py-4.5 font-black focus:ring-4 focus:ring-primary/10 outline-none transition-all appearance-none uppercase tracking-widest text-[11px]"
                >
            ...
            >
              <div className="flex justify-between items-start mb-8 relative z-10">
                <div className="flex flex-wrap gap-2.5">
                  <span className="bg-primary/5 text-primary dark:text-primary text-[10px] font-black px-4 py-2 rounded-xl uppercase tracking-widest border border-primary/10 shadow-inner group-hover:border-primary/30 transition-colors">
                    {task.course_name}
                  </span>
              ...
              <h3 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight leading-tight mb-6 group-hover:text-primary transition-colors min-h-[4.5rem] line-clamp-2 uppercase">{task.title}</h3>
              ...
              <div className="space-y-4 pt-8 border-t border-gray-100 dark:border-white/5 relative z-10">
                ...
                <a 
                  ...
                  className="flex items-center justify-between gap-4 p-5 bg-gray-50/50 dark:bg-white/[0.02] rounded-[1.5rem] border border-gray-100 dark:border-white/10 hover:border-primary/40 hover:bg-white dark:hover:bg-white/5 transition-all group/link shadow-inner"
                >
                  <div className="flex items-center gap-4 overflow-hidden">
                    <div className="w-11 h-11 bg-white dark:bg-black border border-gray-100 dark:border-white/10 rounded-xl flex items-center justify-center shadow-sm group-hover/link:border-primary/30 transition-colors">
                  ...
                  <ExternalLink className="w-4 h-4 text-gray-300 dark:text-slate-700 group-hover/link:text-primary transition-colors" />
                </a>
              </div>
            </div>
          ))}
      ...
      {showForm && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          <div className="bg-white dark:bg-[#080808] border border-gray-100 dark:border-white/5 rounded-[3.5rem] p-8 lg:p-12 w-full max-w-3xl shadow-2xl relative overflow-hidden z-10 animate-in zoom-in duration-500" onClick={e => e.stopPropagation()}>
             ...
             <div className="relative z-10 text-start">
                <div className="flex items-center justify-between mb-10 pb-8 border-b border-gray-100 dark:border-white/5">
                    <div className="flex items-center gap-6">
                      <div className="w-16 h-16 bg-primary/10 dark:bg-primary/20 rounded-[1.5rem] flex items-center justify-center border border-primary/20 text-primary dark:text-primary shadow-inner">
                ...
                <form id="task-form" onSubmit={handleSubmit} className="space-y-8">
                       ...
                       <div className="space-y-3">
                          ...
                          <div className="relative">
                             ...
                             <select
                                ...
                                className="w-full bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/10 rounded-2xl ps-14 pe-8 py-5 text-gray-900 dark:text-white font-black focus:ring-4 focus:ring-primary/10 outline-none transition-all shadow-inner appearance-none uppercase tracking-widest text-[11px]"
                                required
                             >
                    ...
                    <div className="space-y-3">
                       ...
                       <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/10 rounded-2xl ps-14 pe-6 py-5 text-gray-900 dark:text-white text-lg font-black focus:ring-4 focus:ring-primary/10 outline-none transition-all shadow-inner uppercase"
                            required
                          />
                       </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                       <div className="space-y-3">
                          ...
                          <div className="relative">
                             <LinkIcon className="absolute inset-inline-start-5 top-1/2 -translate-y-1/2 w-5 h-5 text-primary" />
                             <input
                                type="url"
                                placeholder={t('admin.tasks.placeholder_url')}
                                value={formData.drive_link}
                                onChange={(e) => setFormData({ ...formData, drive_link: e.target.value })}
                                className="w-full bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/10 rounded-2xl ps-14 pe-6 py-5 text-gray-900 dark:text-white font-black focus:ring-4 focus:ring-primary/10 outline-none transition-all shadow-inner"
                                required
                             />
                          </div>
                       </div>
                    ...
                    <div className="space-y-3">
                       ...
                       <textarea
                         ...
                         className="w-full bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/10 rounded-[2rem] p-8 text-gray-900 dark:text-white font-bold focus:ring-4 focus:ring-primary/10 outline-none transition-all shadow-inner resize-none min-h-[120px]"
                       />
                    </div>
