        ...
        <div className="relative z-10">
            ...
            <form onSubmit={handleSaveQuiz} className="space-y-10">
                ...
                <div className="flex gap-4 pt-6 border-t border-gray-100 dark:border-white/10">
                    ...
                    <button type="button" onClick={resetQuizForm} className="px-12 py-5 bg-gray-100 dark:bg-white/5 text-gray-700 dark:text-gray-300 font-bold uppercase tracking-widest rounded-2xl transition-all">{t('admin.quizzes.form.cancel_btn')}</button>
                </div>
            </form>
        </div>
      </div>
