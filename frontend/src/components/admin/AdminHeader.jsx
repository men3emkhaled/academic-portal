...
const AdminHeader = ({
  ...
  return (
    <header className="h-20 lg:h-24 bg-white dark:bg-[#050505] border-b border-gray-200 dark:border-white/[0.03] flex items-center justify-between px-6 lg:px-12 z-40 transition-[background-color,border-color] duration-300">
