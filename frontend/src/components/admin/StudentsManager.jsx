  ...
  return (
    <div className="space-y-8 lg:space-y-10 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="relative flex-1 group">
          ...
          <input 
            ...
            className="w-full bg-white/50 dark:bg-white/[0.02] backdrop-blur-md border border-gray-100 dark:border-white/5 rounded-2xl lg:rounded-[2rem] ps-14 pe-6 py-4.5 text-sm font-black text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-4 focus:ring-emerald-500/10 transition-all shadow-inner"
          />
        </div>
        <button
      ...
      <div className="bg-white/50 dark:bg-white/[0.01] backdrop-blur-xl border border-gray-100 dark:border-white/5 rounded-[3rem] p-8 lg:p-10 shadow-sm relative overflow-hidden group">
        <div className="absolute -inset-inline-end-20 -top-20 w-80 h-80 bg-emerald-500/5 rounded-full blur-[80px] pointer-events-none group-hover:scale-110 transition-transform duration-1000"></div>
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleUploadStudents} className="flex flex-col md:flex-row items-stretch gap-6">
            <label className="relative flex-1 flex flex-col items-center justify-center gap-4 cursor-pointer bg-white/30 dark:bg-white/[0.01] border-2 border-gray-100 dark:border-white/5 border-dashed rounded-[2.5rem] p-10 hover:border-emerald-500/40 hover:bg-emerald-500/5 transition-all group/label shadow-inner overflow-hidden">
              ...
              <FileSpreadsheet className="w-10 h-10 text-gray-300 group-hover/label:text-emerald-500 group-hover/label:scale-110 transition-all duration-500 relative z-10" />
                  ...
                  >
                    <td className="py-6 px-8">
                      <div className="flex items-center gap-5">
                        <div className="w-14 h-14 bg-white dark:bg-black rounded-2xl flex items-center justify-center border border-gray-100 dark:border-white/10 shadow-inner group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 overflow-hidden relative">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-gray-400 dark:text-gray-500 font-black uppercase tracking-[0.3em] mt-1 group-hover:tracking-[0.4em] transition-all">{s.id}</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-6 px-8">
                    ...
                    <td className="py-6 px-8">
                      <div className="flex items-center justify-inline-end gap-3">
                        <button 
                            ...
                            className="w-10 h-10 flex items-center justify-center rounded-xl bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 text-gray-400 hover:text-blue-500 hover:border-blue-500/30 hover:scale-110 active:scale-95 transition-all shadow-sm"
                        ...
                        <button 
                            ...
                            className="w-10 h-10 flex items-center justify-center rounded-xl bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 text-gray-400 hover:text-emerald-500 hover:border-emerald-500/30 hover:scale-110 active:scale-95 transition-all shadow-sm"
                        ...
                        <button 
                            ...
                            className={`w-10 h-10 flex items-center justify-center rounded-xl border transition-all hover:scale-110 active:scale-95 shadow-sm ${
                        ...
                        <button 
                            ...
                            className="w-10 h-10 flex items-center justify-center rounded-xl bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 text-gray-400 hover:text-rose-500 hover:border-rose-500/30 hover:scale-110 active:scale-95 transition-all shadow-sm"
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 lg:p-10">
          ...
          >
            {/* Modal Glows */}
            <div className="absolute top-0 inset-inline-end-0 w-64 h-64 bg-emerald-500/10 blur-[100px] rounded-full pointer-events-none group-hover:scale-110 transition-transform duration-1000"></div>
              ...
              <form onSubmit={handleAddSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-3">
                        ...
                        <input type="number" value={newStudent.level} onChange={(e) => setNewStudent({ ...newStudent, level: e.target.value })} className="w-full bg-gray-50 dark:bg-white/[0.02] text-gray-900 dark:text-white border border-gray-100 dark:border-white/10 rounded-2xl px-6 py-4.5 font-black focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all shadow-inner" min="1" max="4" />
                    </div>
                    <div className="space-y-3">
                ...
                <div className="space-y-3">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="w-full bg-gray-50 dark:bg-white/[0.02] text-gray-900 dark:text-white border border-gray-100 dark:border-white/10 rounded-2xl px-6 py-4.5 font-black focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all shadow-inner appearance-none uppercase tracking-widest text-[11px]"
                        >
                ...
                <div className="flex gap-4 pt-10 border-t border-gray-100 dark:border-white/5">
                  <button type="submit" disabled={adding} className="flex-1 bg-emerald-500 hover:bg-emerald-600 text-white font-black py-5 rounded-[2rem] shadow-xl shadow-emerald-500/20 transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-50">
                  ...
                  <button type="button" onClick={() => setShowAddModal(false)} className="px-12 bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 text-gray-700 dark:text-gray-300 font-black py-5 rounded-[2rem] transition-all uppercase tracking-widest text-xs">
                    {t('common.cancel')}
                  </button>
                </div>
              </form>
