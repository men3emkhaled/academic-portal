        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight flex items-center gap-3">
              <Users className="w-6 h-6 text-blue-500 dark:text-blue-400" /> Manage Students
            </h2>
            <p className="text-gray-500 dark:text-slate-500 text-xs font-bold uppercase tracking-[0.2em] mt-1">Student Registry & Authentication</p>
          </div>
        </div>
        <div className="flex items-center gap-4 w-full md:w-auto">
          <div className="relative flex-1 md:w-64">
            ...
            <input 
              ...
              className="w-full bg-gray-100 dark:bg-slate-900/50 border border-gray-200 dark:border-white/5 rounded-2xl pl-12 pr-4 py-3 text-sm text-gray-700 dark:text-slate-200 focus:outline-none focus:border-blue-500/50 transition-all transition-colors"
            />
          </div>
          <button
      ...
      <div className="mb-12 admin-card relative overflow-hidden group transition-colors">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-black text-gray-900 dark:text-white tracking-tight">Bulk Upload (Excel)</h3>
          </div>
          
          <div className="bg-gray-50 dark:bg-slate-900/40 border border-gray-200 dark:border-white/5 rounded-2xl p-4 mb-6 transition-colors">
            <p className="text-gray-500 dark:text-slate-400 text-sm leading-relaxed">
              <span className="text-emerald-600 dark:text-emerald-400 font-bold uppercase text-[10px] tracking-widest block mb-2">Required Columns:</span>
          ...
          <form onSubmit={handleUploadStudents} className="flex flex-wrap items-center gap-6">
            <div className="flex-1 min-w-[300px]">
              <label className="relative flex items-center justify-center gap-3 cursor-pointer bg-gray-50 dark:bg-slate-900/50 border border-gray-200 dark:border-white/5 border-dashed rounded-2xl px-6 py-6 hover:border-emerald-500/50 hover:bg-emerald-500/5 transition-all group/label transition-colors">
                <FileSpreadsheet className="w-6 h-6 text-gray-400 dark:text-slate-500 group-hover/label:text-emerald-600 dark:group-hover/label:text-emerald-400 transition-colors" />
                <span className="text-gray-700 dark:text-slate-300 font-bold text-sm tracking-tight">
      ...
      <div className="bg-white dark:bg-[#111111]/40 border border-gray-200 dark:border-white/5 rounded-[2rem] overflow-hidden shadow-sm dark:shadow-inner transition-colors">
        <div className="p-6 border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.02] flex justify-between items-center">
            <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-gray-500 dark:text-slate-400 uppercase tracking-widest">Active Database Records</span>
            </div>
            <span className="text-xs font-bold text-gray-500 dark:text-slate-500 bg-gray-100 dark:bg-white/5 px-3 py-1 rounded-lg border border-gray-200 dark:border-white/5">{filteredStudents.length} / {students.length} Entries</span>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 dark:bg-white/[0.01]">
                <th className="py-5 px-6 text-[10px] font-black text-gray-400 dark:text-slate-500 uppercase tracking-[0.2em]">Student Details</th>
                <th className="py-5 px-6 text-[10px] font-black text-gray-400 dark:text-slate-500 uppercase tracking-[0.2em]">Academic Info</th>
                <th className="py-5 px-6 text-[10px] font-black text-gray-400 dark:text-slate-500 uppercase tracking-[0.2em]">Security</th>
                <th className="py-5 px-6 text-[10px] font-black text-gray-400 dark:text-slate-500 uppercase tracking-[0.2em] text-right">Operations</th>
              </tr>
            </thead>
                ...
                <tr>
                    <td colSpan="4" className="text-center py-20">
                        <div className="flex flex-col items-center gap-3">
                            <Users className="w-12 h-12 text-gray-200 dark:text-slate-800" />
                            <p className="text-gray-400 dark:text-slate-600 font-bold">No student records found in current node.</p>
                        </div>
                    </td>
                </tr>
              ) : (
                    ...
                    <td className="py-5 px-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 dark:text-slate-500 text-xs font-bold uppercase tracking-widest mt-0.5">{s.id}</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-5 px-6">
                      <div className="flex flex-wrap gap-2">
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-600 dark:text-blue-400 text-[10px] font-black uppercase tracking-tight">
                          <Layers className="w-3 h-3" /> Lvl {s.level}
                        </span>
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-purple-500/10 border border-purple-500/20 text-purple-600 dark:text-purple-400 text-[10px] font-black uppercase tracking-tight">
                          <Activity className="w-3 h-3" /> Sec {s.section || '—'}
                        </span>
                        {s.department_name && (
                            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-[10px] font-black uppercase tracking-tight">
                    ...
                    <td className="py-5 px-6">
                      <div className="flex items-center justify-end gap-2">
                        <button 
                            ...
                            className="w-10 h-10 flex items-center justify-center rounded-xl bg-blue-500/10 text-blue-600 dark:text-blue-400 hover:bg-blue-600 dark:hover:bg-blue-500 hover:text-white transition-all group/btn"
                        ...
                        <button 
                            ...
                            className="w-10 h-10 flex items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-600 dark:hover:bg-emerald-500 hover:text-white dark:hover:text-black transition-all group/btn"
                            title="Edit Info"
                        >
                        ...
                        <button 
                            ...
                            className={`w-10 h-10 flex items-center justify-center rounded-xl transition-all group/btn ${
                                ...
                                ? 'bg-amber-500/20 text-amber-600 dark:text-amber-400 hover:bg-amber-600 dark:hover:bg-amber-500 hover:text-white dark:hover:text-black shadow-sm dark:shadow-[0_0_10px_rgba(245,158,11,0.2)]' 
                                : 'bg-yellow-500/10 text-yellow-600 dark:text-yellow-400 hover:bg-yellow-600 dark:hover:bg-yellow-500 hover:text-white dark:hover:text-black'
                            }`}
                        ...
                        <button 
                            ...
                            className="w-10 h-10 flex items-center justify-center rounded-xl bg-red-500/10 text-red-600 dark:text-red-400 hover:bg-red-600 dark:hover:bg-red-500 hover:text-white transition-all group/btn"
          ...
          <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-[2.5rem] p-10 w-full max-w-lg shadow-2xl relative overflow-hidden animate-fadeInUp transition-colors">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-12 h-12 bg-blue-500/10 dark:bg-blue-500/20 rounded-2xl flex items-center justify-center border border-blue-500/20 dark:border-blue-500/30">
                  <UserPlus className="w-6 h-6 text-blue-600 dark:text-blue-400" />
                </div>
                <div>
                  <h3 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight">Add New Student</h3>
                  <p className="text-gray-500 dark:text-slate-400 text-xs font-bold uppercase tracking-widest">Manual Registry Entry</p>
                </div>
              </div>
              ...
              <form onSubmit={handleAddSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <label className="block text-gray-600 dark:text-slate-300 ml-4 text-[10px] font-bold uppercase tracking-widest">Student ID *</label>
                ...
                <div className="space-y-2">
                    <label className="block text-gray-600 dark:text-slate-300 ml-4 text-[10px] font-bold uppercase tracking-widest">Initial Password</label>
                ...
                <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <label className="block text-gray-600 dark:text-slate-300 ml-4 text-[10px] font-bold uppercase tracking-widest">Academic Level</label>
                ...
                <div className="space-y-2">
                    <label className="block text-gray-600 dark:text-slate-300 ml-4 text-[10px] font-bold uppercase tracking-widest">Department Assignment</label>
                    <select
