    ...
    <div className="space-y-8 lg:space-y-10 animate-in fade-in duration-700 pb-10">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-stretch gap-6">
        <div className="relative flex-1 group">
          ...
          <input 
            ...
            className="w-full bg-white dark:bg-white/[0.02] border border-gray-100 dark:border-white/10 rounded-[2rem] ps-16 pe-8 py-5 text-gray-900 dark:text-white font-black focus:ring-4 focus:ring-purple-500/10 outline-none transition-[color,background-color,border-color,transform,opacity] shadow-inner uppercase tracking-widest text-[11px]"
          />
        </div>
        
        <button 
          onClick={() => setShowForm(true)}
          className="flex items-center justify-center gap-3 bg-purple-600 hover:bg-purple-700 text-white font-black py-4.5 px-10 rounded-[2rem] shadow-xl shadow-purple-600/20 hover:scale-[1.02] active:scale-95 transition-[color,background-color,border-color,transform,opacity] whitespace-nowrap group/add"
        >
        ...
        >
          {filteredDepts.map((dept, idx) => (
            <div 
              ...
              className="group relative bg-white dark:bg-white/[0.01] border border-gray-100 dark:border-white/5 rounded-[2.5rem] p-10 transition-[color,background-color,border-color,transform,opacity] duration-500 hover:border-purple-500/30 hover:shadow-2xl hover:shadow-purple-500/10"
            >
                {/* Visual Identity */}
                ...
                <div className="flex justify-between items-start mb-8 relative z-10">
                    <div className="w-16 h-16 bg-purple-500/5 dark:bg-purple-500/10 rounded-2xl flex items-center justify-center border border-purple-500/10 text-purple-600 dark:text-purple-400 text-xl font-black shadow-inner group-hover:bg-purple-600 group-hover:text-white transition-[color,background-color,border-color,transform,opacity] duration-700">
                       {dept.code}
                    </div>
                    <div className="flex gap-2.5 opacity-0 group-hover:opacity-100 transition-[color,background-color,border-color,transform,opacity] scale-90 group-hover:scale-100">
                       <button 
                         ...
                         className="w-10 h-10 bg-blue-500/5 text-blue-500 border border-blue-500/10 hover:bg-blue-500 hover:text-white rounded-xl transition-[color,background-color,border-color,transform,opacity] flex items-center justify-center shadow-sm"
                       >
                         <Edit3 className="w-4.5 h-4.5" />
                       </button>
                       <button 
                         onClick={() => handleDelete(dept.id, dept.name)}
                         className="w-10 h-10 bg-rose-500/5 text-rose-500 border border-rose-500/10 hover:bg-rose-500 hover:text-white rounded-xl transition-[color,background-color,border-color,transform,opacity] flex items-center justify-center shadow-sm"
                       >
                ...
                <div className="h-1 bg-purple-500/20 dark:bg-white/5 w-12 mb-6 group-hover:w-24 group-hover:bg-purple-500 transition-[color,background-color,border-color,transform,opacity] duration-700 relative z-10"></div>
      ...
      {showForm && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
           <div    onClick={resetForm} className="absolute inset-0 bg-gray-950/40 dark:bg-black/80" />
           <div 
           ...
           >
              ...
              <div className="p-10 lg:p-12 border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.01] flex justify-between items-center relative z-10">
                 ...
                 <button onClick={resetForm} className="w-12 h-12 flex items-center justify-center bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 text-gray-500 rounded-2xl hover:text-purple-600 transition-[color,background-color,border-color,transform,opacity] shadow-sm">
                    <X className="w-6 h-6" />
                 </button>
              </div>
                       ...
                       <div className="space-y-3">
                          ...
                          <div className="relative group/code">
                              ...
                              <input 
                                ...
                                className="w-full bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/10 rounded-2xl ps-14 pe-6 py-5 text-gray-900 dark:text-white font-black focus:ring-4 focus:ring-purple-500/10 outline-none transition-[color,background-color,border-color,transform,opacity] shadow-inner uppercase tracking-widest text-sm"
                              />
                          </div>
                       </div>
                    ...
                    <div className="space-y-3">
                       ...
                       <div className="relative group/desc">
                          ...
                          <textarea 
                            ...
                            className="w-full bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/10 rounded-[2.5rem] ps-16 pe-8 py-6 text-gray-900 dark:text-white font-bold focus:ring-4 focus:ring-purple-500/10 outline-none transition-[color,background-color,border-color,transform,opacity] shadow-inner resize-none min-h-[140px]"
              ...
              <div className="p-10 lg:p-12 border-t border-gray-100 dark:border-white/5 flex justify-inline-end gap-6 bg-gray-50/50 dark:bg-white/[0.01] relative z-10">
                 <button onClick={resetForm} className="px-10 py-5 rounded-[2rem] font-black text-gray-500 hover:text-gray-900 dark:text-slate-400 dark:hover:text-white transition-[color,background-color,border-color,transform,opacity] uppercase text-[10px] tracking-widest">{t('common.cancel')}</button>
                 <button 
                   type="submit" 
                   form="dept-form"
                   disabled={loading}
                   className="flex items-center gap-3 bg-purple-600 hover:bg-purple-700 text-white px-14 py-5 rounded-[2.5rem] font-black transition-[color,background-color,border-color,transform,opacity] shadow-xl shadow-purple-600/20 active:scale-95 disabled:opacity-50 uppercase text-[10px] tracking-widest"
                 >
