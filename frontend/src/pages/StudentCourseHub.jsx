...
const StudentCourseHub = () => {
      ...
      <div className="flex min-h-screen bg-gray-50 dark:bg-dark-card">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">{t('hub.loading')}</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark text-gray-900 dark:text-white font-body transition-colors duration-300">
      ...
      <main className="md:ps-96 pb-24 md:pb-8 min-h-screen">
        {/* Top Bar */}
        <div className="sticky top-0 z-30 bg-gray-50/80 dark:bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-gray-200 dark:border-white/5" style={{ paddingTop: 'max(0.75rem, env(safe-area-inset-top))' }}>
          <div className="max-w-6xl mx-auto flex items-center justify-between px-6 pb-3">
            <button 
              ...
              className="flex items-center gap-2 text-xs font-bold text-gray-500 hover:text-primary transition-all group uppercase tracking-widest text-start"
            >
              <div className="w-8 h-8 rounded-full bg-white dark:bg-dark-card border border-gray-200 dark:border-white/5 flex items-center justify-center group-hover:border-primary/30 group-hover:shadow-sm">
                <ArrowLeft className="w-4 h-4 group-hover:-inline-start-1 transition-transform" />
              </div>
              <span className="hidden sm:inline">{t('hub.back_dashboard')}</span>
              <span className="sm:hidden">{t('hub.back')}</span>
            </button>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                      <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm">
                        ...
                        <span className="font-semibold text-gray-700 dark:text-gray-300">{course.doctor_name || t('hub.faculty_member')}</span>
                      </div>
                      <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm">
                        <Calendar className="w-4 h-4 text-primary/70" />
                        <span className="font-semibold">{new Date().getFullYear()} {t('hub.session')}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 sm:flex items-center gap-3 flex-shrink-0">
                   <div className="px-4 py-4 bg-gray-50 dark:bg-dark-glass/30 rounded-2xl border border-gray-100 dark:border-white/5 flex flex-col items-center gap-1.5 min-w-[90px] sm:min-w-[110px] hover:border-primary/30 transition-colors">
                      ...
                      <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest text-center">{t('hub.progress.title')}</p>
                   ...
                   <div className="px-4 py-4 bg-gray-50 dark:bg-dark-glass/30 rounded-2xl border border-gray-100 dark:border-white/5 flex flex-col items-center gap-1.5 min-w-[90px] sm:min-w-[110px] hover:border-emerald-500/30 transition-colors">
                      ...
                      <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest text-center">{t('hub.tasks.title')}</p>
                   ...
                   <div className="px-4 py-4 bg-gray-50 dark:bg-dark-glass/30 rounded-2xl border border-gray-100 dark:border-white/5 flex flex-col items-center gap-1.5 min-w-[90px] sm:min-w-[110px] hover:border-blue-500/30 transition-colors">
                      ...
                      <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest text-center">{t('hub.attendance.title')}</p>
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="min-h-[400px]">
                {activeTab === 'announcements' && (
                  <div className="space-y-4 animate-fadeIn">
                    {announcements.length === 0 ? (
                      <EmptyState icon={Megaphone} text={t('hub.announcements.no_news')} sub={t('hub.announcements.no_news_sub')} />
                    ) : (
                ...
                {activeTab === 'progress' && (
                  <div className="space-y-4 animate-fadeIn">
                    {progress.length === 0 ? (
                      <EmptyState icon={ListChecks} text={t('hub.progress.title')} sub={t('hub.progress.desc')} />
                    ) : (
                      <>
                        <div className="bg-white dark:bg-dark-card border border-gray-200 dark:border-white/5 rounded-3xl p-6 shadow-sm">
                          <div className="flex items-center justify-between mb-4">
                            <div>
                                <h3 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-wider">{t('hub.progress.curriculum')}</h3>
                                <p className="text-xs font-bold text-gray-400 mt-0.5">{t('hub.progress.desc')}</p>
                            </div>
                            ...
                            <div key={item.id} className={`flex items-center gap-4 p-4 rounded-2xl border transition-all hover:translate-x-1 ${
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-0.5">
                                  {item.is_completed ? t('hub.progress.completed_topic') : t('hub.progress.upcoming_lesson')}
                                </span>
                              </div>
                ...
                {activeTab === 'tasks' && (
                  <div className="space-y-4 animate-fadeIn">
                    {tasks.length === 0 ? (
                      <EmptyState icon={CheckCircle2} text={t('hub.tasks.no_tasks')} sub={t('hub.tasks.no_tasks_sub')} />
                    ) : (
                      tasks.map(task => (
                              ...
                              <div className="min-w-0">
                                ...
                                <div className="flex flex-wrap items-center gap-3">
                                  <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest flex items-center gap-1.5">
                                    ...
                                    {t('hub.tasks.due', { date: task.deadline ? new Date(task.deadline).toLocaleDateString() : t('hub.tasks.indefinite') })}
                                  </span>
                                  {task.requires_submission && (
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                  <div className="relative flex-1">
                                    <input 
                                      ...
                                      className="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-2xl ps-5 pe-5 py-3.5 text-sm text-gray-900 dark:text-white focus:border-primary/50 focus:ring-4 focus:ring-primary/5 focus:outline-none transition-all"
                                    />
                                  </div>
                                  <button 
                                ...
                                <div className="bg-gray-50 dark:bg-white/5 rounded-2xl p-5 border border-gray-100 dark:border-white/5 space-y-4">
                                  {task.submission_url && (
                                    <div className="flex flex-col gap-1">
                                      <span className="text-[10px] font-black text-gray-400 uppercase tracking-[0.1em]">{t('hub.tasks.submitted_evidence')}</span>
                                    ...
                                    <div className="pt-4 border-t border-gray-200 dark:border-white/10 grid grid-cols-1 sm:grid-cols-4 gap-4">
                                      {task.grade && (
                                        <div className="sm:col-span-1">
                                          <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-1">{t('hub.tasks.score')}</span>
                                          <span className="text-lg font-black text-emerald-600 dark:text-emerald-400">{task.grade}</span>
                                        </div>
                                      )}
                                      {task.feedback && (
                                        <div className="sm:col-span-3">
                                          <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-1">{t('hub.tasks.instructor_review')}</span>
                ...
                {activeTab === 'attendance' && (
                  <div className="space-y-5 animate-fadeIn">
                    {attendance.length === 0 ? (
                      <EmptyState icon={Users} text={t('hub.attendance.history')} sub={t('hub.attendance.missed')} />
                    ) : (
                      <>
                        <div className="grid grid-cols-2 gap-4">
                          <div className="bg-white dark:bg-dark-card border border-gray-200 dark:border-white/5 rounded-3xl p-6 flex items-center justify-between shadow-sm hover:border-emerald-500/30 transition-all group">
                            <div>
                              <p className="text-[10px] font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest mb-1.5">{t('hub.attendance.present')}</p>
                          ...
                          <div className="bg-white dark:bg-dark-card border border-gray-200 dark:border-white/5 rounded-3xl p-6 flex items-center justify-between shadow-sm hover:border-rose-500/30 transition-all group">
                            <div>
                              <p className="text-[10px] font-black text-rose-600 dark:text-rose-400 uppercase tracking-widest mb-1.5">{t('hub.attendance.absent')}</p>
                        ...
                        <div className="bg-white dark:bg-dark-card border border-gray-200 dark:border-white/5 rounded-3xl overflow-hidden shadow-sm">
                          <div className="p-4 bg-gray-50 dark:bg-white/[0.02] border-b border-gray-200 dark:border-white/5">
                             <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">{t('hub.attendance.history')}</h4>
                          </div>
                            ...
                            {attendance.map((record) => (
                              ...
                              >
                                <div className="flex items-center gap-4">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-0.5">
                                      {record.is_present ? t('hub.attendance.verified') : t('hub.attendance.missed')}
                                    </p>
                                  </div>
                                </div>
                                <div className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border transition-all ${
                                  ...
                                  {record.is_present ? t('hub.attendance.status_present') : t('hub.attendance.status_absent')}
                                </div>
                              </div>
                            ))}
                          </div>
                  ...
                  <div className="space-y-8 animate-fadeIn">
                    ...
                    <div className="bg-white dark:bg-dark-card border border-gray-200 dark:border-white/5 rounded-[2.5rem] p-8 shadow-sm">
                      <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                          <h3 className="text-xl font-black text-gray-900 dark:text-white">{t('hub.support.title')}</h3>
                          <p className="text-xs font-bold text-gray-400 mt-1 uppercase tracking-widest">{t('hub.support.desc')}</p>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmitInquiry} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-2">
                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ms-4">{t('hub.support.type')}</label>
                            <div className="flex p-1.5 bg-gray-50 dark:bg-black/20 rounded-[1.5rem] border border-gray-200 dark:border-white/5">
                              ...
                              >
                                ...
                                {t('hub.support.complaint')}
                              </button>
                            </div>
                          </div>
                          <div className="space-y-2">
                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ms-4">{t('hub.support.subject')}</label>
                            <input 
                              type="text"
                              value={inquirySubject}
                              onChange={(e) => setInquirySubject(e.target.value)}
                              placeholder={t('hub.support.placeholder_subject')}
                        ...
                        <div className="space-y-2">
                          <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ms-4">{t('hub.support.message')}</label>
                          <textarea 
                            rows="4"
                            value={inquiryContent}
                            onChange={(e) => setInquiryContent(e.target.value)}
                            placeholder={t('hub.support.placeholder_message')}
                    ...
                    <div className="space-y-4">
                       <h4 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest ms-4">{t('hub.support.history')}</h4>
                       {inquiries.length === 0 ? (
                         <div className="bg-white/30 dark:bg-white/[0.01] border border-dashed border-gray-200 dark:border-white/5 rounded-[2.5rem] p-12 text-center">
                            <p className="text-gray-400 font-bold">{t('hub.support.no_history')}</p>
                         </div>
                       ) : (
                         inquiries.map(inq => (
                           <div key={inq.id} className="bg-white dark:bg-dark-card border border-gray-200 dark:border-white/5 rounded-3xl p-6 shadow-sm space-y-4">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                  <span className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-wider border ${
                                    ...
                                    {inq.type === 'complaint' ? t('hub.support.complaint') : t('hub.support.question')}
                                  </span>
                                  <span className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-wider border ${
                                    ...
                                    {inq.status === 'replied' ? t('hub.support.replied') : t('hub.support.pending')}
                                  </span>
                                </div>
                              ...
                              {inq.doctor_reply && (
                                <div className="mt-4 p-5 bg-primary/5 border border-primary/10 rounded-2xl relative">
                                  <div className="absolute -top-3 start-6 px-3 py-1 bg-primary text-white text-[9px] font-black uppercase tracking-widest rounded-lg">{t('hub.support.instructor_reply')}</div>
            ...
            <div className="hidden lg:block lg:col-span-4 space-y-6">
              ...
              <div className="sticky top-24">
                <div className="bg-white dark:bg-dark-card border border-gray-200 dark:border-white/5 rounded-[2.5rem] p-8 text-center relative overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500">
                  ...
                  <h3 className="font-headline font-black text-xl text-gray-900 dark:text-white mb-2 uppercase tracking-tight">{t('hub.qr.title')}</h3>
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-8">{t('hub.qr.desc')}</p>
                  ...
                  <div className="mt-8 flex flex-col gap-3">
                    ...
                    <div className="px-6 py-4 bg-gray-50 dark:bg-white/5 rounded-2xl text-start border border-gray-100 dark:border-white/5">
                       <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-1">{t('hub.qr.status')}</p>
                       <p className="text-xs font-bold text-gray-700 dark:text-gray-300 leading-relaxed">{t('hub.qr.status_desc')}</p>
                    </div>
                  </div>
                </div>
              </div>
