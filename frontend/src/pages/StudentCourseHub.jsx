  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-[#050505] text-gray-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <main className="flex-1 overflow-y-auto pb-24 lg:pb-8">
        {/* Top Bar */}
        <div className="sticky top-0 z-20 bg-gray-50/80 dark:bg-[#050505]/80 backdrop-blur-xl border-b border-gray-200/50 dark:border-white/5 px-4 sm:px-6 lg:px-10 py-3">
