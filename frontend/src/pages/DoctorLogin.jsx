            ...
            >
               ...
               >
                  ...
                  <div className="text-start mb-12">
                     ...
                     <p className="mt-4 text-sm font-bold text-gray-400 uppercase tracking-widest">{t('auth.instructor_portal')}</p>
                  </div>
                  ...
                  <form onSubmit={handleLogin} className="space-y-10">
                     <div className="space-y-6">
                        <div className="space-y-3">
                           ...
                           <div className={`group relative flex items-center rounded-[2.5rem] border transition-all duration-500 focus-within:ring-8 focus-within:ring-violet-500/5 ${isDarkMode ? 'bg-black/40 border-white/5 focus-within:border-violet-500' : 'bg-gray-50 border-gray-100 focus-within:border-violet-500 shadow-inner'}`}>
                              <Mail className={`ms-8 w-6 h-6 transition-colors ${isDarkMode ? 'text-white/10 group-focus-within:text-violet-500' : 'text-gray-300 group-focus-within:text-violet-500'}`} />
                              <input
                                 type="email"
                        ...
                        <div className="space-y-3">
                           ...
                           <div className={`group relative flex items-center rounded-[2.5rem] border transition-all duration-500 focus-within:ring-8 focus-within:ring-violet-500/5 ${isDarkMode ? 'bg-black/40 border-white/5 focus-within:border-violet-500' : 'bg-gray-50 border-gray-100 focus-within:border-violet-500 shadow-inner'}`}>
                              <Lock className={`ms-8 w-6 h-6 transition-colors ${isDarkMode ? 'text-white/10 group-focus-within:text-violet-500' : 'text-gray-300 group-focus-within:text-violet-500'}`} />
                              <input
                                 type="password"
